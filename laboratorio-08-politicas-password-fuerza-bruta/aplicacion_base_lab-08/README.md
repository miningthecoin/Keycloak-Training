...
Estado: laboratorio 08 completado. La aplicación es idéntica a la del
laboratorio 07 (autenticación OpenID Connect con Authorization Code +
PKCE, cierre de sesión RP-Initiated Logout, caducidad de sesión por
inactividad, autorización por rol de realm y scopes mínimos). El
laboratorio 08 **no cambia ninguna línea de la aplicación**: endurece la
política de contraseñas y activa la detección de fuerza bruta, que son
ajustes del realm en Keycloak. Es justo la lección: la aplicación nunca
custodia contraseñas, así que reforzarlas no la toca.
