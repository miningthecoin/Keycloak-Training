...
Estado: laboratorio 09 completado. La aplicación es idéntica a la de los
laboratorios 07 y 08 (autenticación OpenID Connect con Authorization Code
+ PKCE, cierre de sesión RP-Initiated Logout, caducidad de sesión por
inactividad, autorización por rol de realm y scopes mínimos). Los
laboratorios 08 y 09 **no cambian ninguna línea de la aplicación**: el 08
endurece la política de contraseñas y activa la detección de fuerza
bruta, y el 09 añade un segundo factor (TOTP). Todo son ajustes del realm
en Keycloak. Es justo la lección: la aplicación delega la autenticación,
así que reforzarla no la toca.
