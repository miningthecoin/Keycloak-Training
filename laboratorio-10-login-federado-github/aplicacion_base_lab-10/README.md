...
Estado: laboratorio 10 completado. La aplicación es idéntica a la de los
laboratorios 07, 08 y 09 (autenticación OpenID Connect con Authorization
Code + PKCE, cierre de sesión RP-Initiated Logout, caducidad de sesión por
inactividad, autorización por rol de realm y scopes mínimos). Los
laboratorios 08, 09 y 10 **no cambian ninguna línea de la aplicación**: el
08 endurece la política de contraseñas y la fuerza bruta, el 09 añade un
segundo factor (TOTP) y el 10 permite iniciar sesión con una cuenta de
GitHub (identity brokering). Todo son ajustes del realm en Keycloak. Es
justo la lección: la aplicación delega la autenticación, así que ni
reforzarla ni añadir proveedores externos la tocan.
