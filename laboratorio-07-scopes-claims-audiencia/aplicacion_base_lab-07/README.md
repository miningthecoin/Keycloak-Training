...
Estado: laboratorio 07 completado (autenticación OpenID Connect con
Authorization Code + PKCE, cierre de sesión RP-Initiated Logout, caducidad
de sesión por inactividad, autorización por rol de realm y **scopes
mínimos: la aplicación pide solo `openid profile`**).
